...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        return "<brand_id=%s name=%s HQ=%s founded=%d>" % (self.brand_id, self.name, self.headquarters, self.founded)
...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return "<model_id=%s name=%s year=%d brand_id=%s>" % (self.model_id, self.name, self.year, self.brand_id)
